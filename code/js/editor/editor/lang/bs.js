...
RemoveFormat		: "Poni?ti format",
InsertLinkLbl		: "Link",
InsertLink			: "Ubaci/Izmjeni link",
RemoveLink			: "Izbri?i link",
...
ShowTableBorders	: "Poka?i okvire tabela",
ShowDetails			: "Poka?i detalje",
Style				: "Stil",
FontFormat			: "Format",
Font				: "Font",
FontSize			: "Velièina",
...
InsertRow			: "Ubaci red",
DeleteRows			: "Bri?i redove",
InsertColumn		: "Ubaci kolonu",
DeleteColumns		: "Bri?i kolone",
InsertCell			: "Ubaci ?eliju",
DeleteCells			: "Bri?i ?elije",
MergeCells			: "Spoji ?elije",
SplitCell			: "Razdvoji ?eliju",
...
Done				: "Gotovo",
PasteWordConfirm	: "Tekst koji ?elite zalijepiti èini se da je kopiran iz Worda. Da li ?elite da se prvo oèisti?",
NotCompatiblePaste	: "Ova komanda je podr?ana u Internet Explorer-u verzijama 5.5 ili novijim. Da li ?elite da izvr?ite lijepljenje teksta bez èi??enja?",
...
DlgTableAlignNotSet	: "<Nije pode?eno>",
...
DlgTableCellSpace	: "Razmak ?elija",
DlgTableCellPad		: "Uvod ?elija",
...
DlgFindTitle		: "Naei",
DlgFindFindBtn		: "Naei",
DlgFindNotFoundMsg	: "Tra?eni tekst nije pronaeen.",

// Replace Dialog
DlgReplaceTitle			: "Zamjeni",
DlgReplaceFindLbl		: "Naei ?ta:",
DlgReplaceReplaceLbl	: "Zamjeni sa:",
DlgReplaceCaseChk		: "Uporeeuj velika/mala slova",
DlgReplaceReplaceBtn	: "Zamjeni",
DlgReplaceReplAllBtn	: "Zamjeni sve",
DlgReplaceWordChk		: "Uporeeuj samo cijelu rijeè",

// Paste Operations / Dialog
PasteErrorPaste	: "Sigurnosne postavke va?eg pretra?ivaèa ne dozvoljavaju operacije automatskog lijepljenja. Molimo koristite kraticu na tastaturi (Ctrl+V).",
PasteErrorCut	: "Sigurnosne postavke va?eg pretra?ivaèa ne dozvoljavaju operacije automatskog rezanja. Molimo koristite kraticu na tastaturi (Ctrl+X).",
PasteErrorCopy	: "Sigurnosne postavke Va?eg pretra?ivaèa ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tastaturi (Ctrl+C).",
