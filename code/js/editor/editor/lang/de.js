...
DeleteColumns		: "Spalte l?schen",
InsertCell			: "Zelle einfügen",
DeleteCells			: "Zelle l?schen",
...
Done				: "Fertig",
PasteWordConfirm	: "Der Text, den Sie einfügen M?chten, scheint aus Word kopiert zu sein. M?chten Sie ihn zuvor bereinigen lassen?",
NotCompatiblePaste	: "Diese Funktion steht nur im Internet Explorer ab Version 5.5 zur Verfügung. M?chten Sie den Text unbereinigt einfügen?",
...
DlgImgWidth			: "Breite",
DlgImgHeight		: "H?he",
DlgImgLockRatio		: "Gr??enverhaeltniss beibehalten",
DlgBtnResetSize		: "Gr??e zuruecksetzen",
DlgImgBorder		: "Rahmen",
...
DlgLnkURL			: "URL",
DlgLnkAnchorSel		: "Anker ausw?hlen",
...
DlgLnkPopDependent	: "Abh?ngig (Netscape)",
DlgLnkPopWidth		: "Breite",
DlgLnkPopHeight		: "H?he",
...
DlgColorSelected	: "Ausgew?hlt",

// Smiley Dialog
DlgSmileyTitle		: "Smiley ausw?hlen",

// Special Character Dialog
DlgSpecialCharTitle	: "Sonderzeichen ausw?hlen",
...
DlgPasteMsg2	: "Bitte fügen Sie den Text in der folgenden Box über die Tastatur (mit <STRONG>Ctrl+V</STRONG>) ein und best?tigen Sie mit <STRONG>OK</STRONG>.",
DlgPasteIgnoreFont		: "Ignoriere Schriftart-Definitionen",
DlgPasteRemoveStyles	: "Entferne Style-Definitionen",
DlgPasteCleanBox		: "Inhalt aufr?umen",
...
DlgSpellNotInDic		: "Nicht im W?rterbuch",
DlgSpellChangeTo		: "?endern in",
...
DlgSpellBtnUndo			: "Rückg?ngig",
DlgSpellNoSuggestions	: " - keine Vorschl?ge - ",
DlgSpellProgress		: "Rechtschreibprüfung l?uft...",
DlgSpellNoMispell		: "Rechtschreibprüfung abgeschlossen - keine Fehler gefunden",
DlgSpellNoChanges		: "Rechtschreibprüfung abgeschlossen - keine Worte ge?ndert",
DlgSpellOneChange		: "Rechtschreibprüfung abgeschlossen - ein Wort ge?ndert",
DlgSpellManyChanges		: "Rechtschreibprüfung abgeschlossen - %1 W?rter ge?ndert",

IeSpellDownload			: "Rechtschreibprüfung nicht installiert. M?chten Sie sie jetzt herunterladen?",
...
DlgCheckboxSelected	: "ausgew?hlt",
...
DlgSelectOpAvail	: "M?gliche Optionen",
DlgSelectOpText		: "Text",
DlgSelectOpValue	: "Wert",
DlgSelectBtnAdd		: "Hinzufügen",
DlgSelectBtnModify	: "?endern",
DlgSelectBtnUp		: "Hoch",
...
DlgLstTypeSRoman	: "Kleine r?mische Zahlen (i, ii, iii)",
DlgLstTypeLRoman	: "Gro?e r?mische Zahlen (I, II, III)",

// Document Properties Dialog
DlgDocGeneralTab	: "Allgemein",
DlgDocBackTab		: "Hintergrund",
DlgDocColorsTab		: "Farben und Abst?nde",
...
DlgDocMargins		: "Seitenr?nder",
DlgDocMaTop			: "Oben",
DlgDocMaLeft		: "Links",
DlgDocMaRight		: "Rechts",
DlgDocMaBottom		: "Unten",
DlgDocMeIndex		: "Schlüsselw?rter (Komma-getrennt)",
...
DlgTemplatesSelMsg	: "Klicken Sie auf eine Vorlage, um sie im Editor zu ?ffnen(der aktuelle Inhalt wird dabei gel?scht!):",
