...
ToolbarCollapse		: "Piilota ty?kalurivi",
ToolbarExpand		: "N?yt? ty?kalurivi",
...
ShowTableBorders	: "N?yt? taulun rajat",
ShowDetails			: "N?yt? muotoilu",
Style				: "Tyyli",
FontFormat			: "Muotoilu",
Font				: "Fontti",
FontSize			: "Koko",
TextColor			: "Tekstiv?ri",
BGColor				: "Taustav?ri",
Source				: "Koodi",
Find				: "Etsi",
Replace				: "Korvaa",
SpellCheck			: "Tarkista oikeinkirjoitus",
UniversalKeyboard	: "Universaali n?pp?imist?",
...
HiddenFieldProp		: "Piilokent?n ominaisuudet",
RadioButtonProp		: "Radiopainikkeen ominaisuudet",
ImageButtonProp		: "Kuvapainikkeen ominaisuudet",
TextFieldProp		: "Tekstikent?n ominaisuudet",
SelectionFieldProp	: "Valintakent?n ominaisuudet",
...
Done				: "Valmis",
PasteWordConfirm	: "Teksti, jonka haluat liitt??, n?ytt?? olevan kopioitu Wordista. Haluatko puhdistaa sen ennen liitt?mist??",
NotCompatiblePaste	: "T?m? komento toimii vain Internet Explorer 5.5:ssa tai uudemmassa. Haluatko liitt?? ilman puhdistusta?",
UnknownToolbarItem	: "Tuntemanton ty?kalu \"%1\"",
UnknownCommand		: "Tuntematon komento \"%1\"",
NotImplemented		: "Komentoa ei ole liitetty sovellukseen",
UnknownToolbarSet	: "Ty?kalukokonaisuus \"%1\" ei ole olemassa",
...
DlgAdvancedTag		: "Lis?ominaisuudet",
DlgOpOther			: "Muut",
DlgInfoTab			: "Info",
DlgAlertUrl			: "Lis?? URL",
...
DlgGenAccessKey		: "Pikan?pp?in",
DlgGenName			: "Nimi",
DlgGenTabIndex		: "Tabulaattori indeksi",
DlgGenLongDescr		: "Pitk?n kuvauksen URL",
DlgGenClass			: "Tyyliluokat",
DlgGenTitle			: "Avustava otsikko",
DlgGenContType		: "Avustava sis?ll?n tyyppi",
...
DlgImgBtnUpload		: "L?het? palvelimelle",
DlgImgURL			: "Osoite",
...
DlgBtnResetSize		: "Alkuper?inen koko",
DlgImgBorder		: "Raja",
...
DlgImgAlignTextTop	: "Yl?s (teksti)",
DlgImgAlignTop		: "Yl?s",
...
DlgFlashChkPlay		: "Automaattinen k?ynnistys",
DlgFlashChkLoop		: "Toisto",
DlgFlashChkMenu		: "N?yt? Flash-valikko",
DlgFlashScale		: "Levit?",
DlgFlashScaleAll	: "N?yt? kaikki",
...
DlgLnkTypeAnchor	: "Ankkuri t?ss? sivussa",
DlgLnkTypeEMail		: "S?hk?posti",
...
DlgLnkNoAnchors		: "&lt;Ei ankkureita t?ss? dokumentissa&gt;",
DlgLnkEMail			: "S?hk?postiosoite",
DlgLnkEMailSubject	: "Aihe",
DlgLnkEMailBody		: "Viesti",
DlgLnkUpload		: "Lis?? tiedosto",
DlgLnkBtnUpload		: "L?het? palvelimelle",
...
DlgTableCellSpace	: "Solujen v?li",
...
DlgCellWordWrap		: "Tekstikierr?tys",
...
DlgCellBackColor	: "Taustav?ri",
DlgCellBorderColor	: "Rajan v?ri",
DlgCellBtnSelect	: "Valitse...",

// Find Dialog
DlgFindTitle		: "Etsi",
DlgFindFindBtn		: "Etsi",
DlgFindNotFoundMsg	: "Etsitty? teksti? ei l?ytynyt.",

// Replace Dialog
DlgReplaceTitle			: "Korvaa",
DlgReplaceFindLbl		: "Etsi mit?:",
DlgReplaceReplaceLbl	: "Korvaa t?ll?:",
...
PasteErrorPaste	: "Selaimesi turva-asetukset eiv?t salli editorin toteuttaa liitt?mist?. K?yt? n?pp?imist?? liitt?miseen (Ctrl+V).",
PasteErrorCut	: "Selaimesi turva-asetukset eiv?t salli editorin toteuttaa leikkaamista. K?yt? n?pp?imist?? leikkaamiseen (Ctrl+X).",
PasteErrorCopy	: "Selaimesi turva-asetukset eiv?t salli editorin toteuttaa kopioimista. K?yt? n?pp?imist?? kopioimiseen (Ctrl+C).",
...
DlgPasteIgnoreFont		: "J?t? huomioimatta fonttim??ritykset",
DlgPasteRemoveStyles	: "Poista tyylim??ritykset",
DlgPasteCleanBox		: "Tyhjenn?",


// Color Picker
ColorAutomatic	: "Automaattinen",
ColorMoreColors	: "Lis?? v?rej?...",
...
DlgSpellBtnIgnore		: "J?t? huomioimatta",
DlgSpellBtnIgnoreAll	: "J?t? kaikki huomioimatta",
DlgSpellBtnReplace		: "Korvaa",
DlgSpellBtnReplaceAll	: "Korvaa kaikki",
DlgSpellBtnUndo			: "Kumoa",
DlgSpellNoSuggestions	: "Ei ehdotuksia",
DlgSpellProgress		: "Tarkistus k?ynniss?...",
DlgSpellNoMispell		: "Tarkistus valmis: Ei virheit?",
DlgSpellNoChanges		: "Tarkistus valmis: Yht??n sanaa ei muutettu",
...
DlgTextMaxChars		: "Maksimi merkkim??r?",
DlgTextType			: "Tyyppi",
...
DlgDocColorsTab		: "V?rit ja marginaalit",
...
DlgDocMeCopy		: "Tekij?noikeudet",
DlgDocPreview		: "Esikatselu",

// Templates Dialog
Templates			: "Pohjat",
DlgTemplatesTitle	: "Sis?lt?pohjat",
DlgTemplatesSelMsg	: "Valitse pohja editoriin<br>(aiempi sis?lt? menetet??n):",
DlgTemplatesLoading	: "Ladataan listaa pohjista. Hetkinen...",
DlgTemplatesNoTpl	: "(Ei m??riteltyj? pohjia)",
