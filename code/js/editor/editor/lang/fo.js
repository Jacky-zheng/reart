...
ToolbarCollapse		: "Goym amboealistan",
ToolbarExpand		: "Vís amboealistan",
...
InsertLineLbl		: "Linja",
InsertLine			: "Seta inn vatnr?tta linju",
...
Bold				: "Feit",
Italic				: "Skástillae",
Underline			: "Undirstrikae",
StrikeThrough		: "Strikae yvir",
Subscript			: "L?kkae skrift",
Superscript			: "H?kkae skrift",
LeftJustify			: "Vinstristillae",
CenterJustify		: "Miestillae",
RightJustify		: "H?gristillae",
BlockJustify		: "Beinir tekstkantar",
DecreaseIndent		: "?kja innrykk",
...
Style				: "Tekstsnie",
FontFormat			: "Sniegeving",
Font				: "Skrift",
FontSize			: "Skriftst?dd",
TextColor			: "Tekstlitur",
BGColor				: "Litur aftanfyri",
Source				: "Kelda",
Find				: "Leita",
Replace				: "Set í staein",
...
InsertColumn		: "Seta inn s?jlur",
DeleteColumns		: "Sletta s?jlur",
InsertCell			: "Seta inn sellu",
DeleteCells			: "Sletta sellu",
MergeCells			: "Fl?tta sellur",
...
AnchorProp			: "Eginleikar fyri staesetingarpunkt",
...
TextareaProp		: "Eginleikar fyri Teksta?ki",
FormProp			: "Eginleikar fyri form",

FontFormats			: "Normalt;Sniegevie;Adressa;Yvirskrift 1;Yvirskrift 2;Yvirskrift 3;Yvirskrift 4;Yvirskrift 5;Yvirskrift 6",

// Alerts and Messages
ProcessingXHTML		: "Viegerir XHTML. Bíea...",
Done				: "Lieugt",
PasteWordConfirm	: "Teksturin, tú roynir at seta inn, synist at vera frá Word. Vilt tú reinsa tekstin, áerenn hann vereur settur inn?",
NotCompatiblePaste	: "Hesin ordri er t?kur í Internet Explorer 5.5 og nyggjari. Vilt tú seta tekstin inn, uttan at reinsa hann?",
UnknownToolbarItem	: "ókendur lutur í amboealinju \"%1\"",
UnknownCommand		: "Kenni ikki ordra \"%1\"",
NotImplemented		: "Ordrin er ikki gj?rdur virkin",
UnknownToolbarSet	: "Amboealinjan \"%1\" finst ikki",
...
DlgGenLangDirLtr	: "Vinstri móti h?gri (LTR)",
DlgGenLangDirRtl	: "H?gri móti vinstri (RTL)",
DlgGenLangCode		: "Málkoda",
DlgGenAccessKey		: "Atgongdslykil",
DlgGenName			: "Navn",
DlgGenTabIndex		: "Tabulator Indeks",
DlgGenLongDescr		: "víeka frágreieing",
...
DlgImgWidth			: "Breidd",
DlgImgHeight		: "H?dd",
DlgImgLockRatio		: "L?s st?ddarlutfall",
DlgBtnResetSize		: "Nulstilla st?dd",
DlgImgBorder		: "Ramma",
...
DlgImgAlignAbsMiddle: "Abs Mieja",
DlgImgAlignBaseline	: "Botnlinja",
DlgImgAlignBottom	: "Botnur",
DlgImgAlignMiddle	: "Mieja",
DlgImgAlignRight	: "H?gra",
DlgImgAlignTextTop	: "Tekstur ovast",
DlgImgAlignTop		: "Ovast",
DlgImgPreview		: "Vís d?mi",
DlgImgAlertUrl		: "Slá inn slóeina til myndina",
...
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "Akker á hesari síeuni",
...
DlgLnkNoAnchors		: "&lt;Tae eru ongi akker t?k í hesum dokumentinum;",
...
DlgCellHorAlignCenter	: "Miesett",
DlgCellHorAlignRight: "H?grastilla",
DlgCellVerAlign		: "Lodr?tt Justering",
DlgCellVerAlignNotSet	: "<Ikki sett>",
DlgCellVerAlignTop	: "Ovast",
DlgCellVerAlignMiddle	: "Mieja",
DlgCellVerAlignBottom	: "Nieast",
DlgCellVerAlignBaseline	: "Botnlinja",
DlgCellRowSpan		: "Tal av rekkjum sellan spennur yvir",
DlgCellCollSpan		: "Tal av talr?eum sellan spennur yvir",
...
// Replace Dialog
DlgReplaceTitle			: "Set í staein",
DlgReplaceFindLbl		: "Finn:",
DlgReplaceReplaceLbl	: "Set í staein vie:",
DlgReplaceCaseChk		: "Munur á stórum og smáeum stavum",
DlgReplaceReplaceBtn	: "Set í staein",
DlgReplaceReplAllBtn	: "Skift alt út",
DlgReplaceWordChk		: "Bert heil ore",

// Paste Operations / Dialog
PasteErrorPaste	: "Leitarans trygdarinstillingar loyva ikki editorinum at innseta tekstin automatiskt. Brúka knappaboreie til at innseta tekstin (Ctrl+V).",
PasteErrorCut	: "Leitarans trygdarinstillingar loyva ikki editorinum at klippa tekstin automatiskt. Brúka í staein knappaboreie til at klippa tekstin (Ctrl+X).",
PasteErrorCopy	: "Leitarans trygdarinstillingar loyva ikki editorinum at avrita tekstin automatiskt. Brúka í staein knappaboreie til at avrita tekstin (Ctrl+V).",
...
DlgSpellNotInDic		: "Finnst ikki í oreabókini",
...
DlgSpellProgress		: "Stavarin arbeieir...",
DlgSpellNoMispell		: "Stavarain lieugur: Eingin feilur funnin",
DlgSpellNoChanges		: "Stavarain lieugur: Einki ore broytt",
DlgSpellOneChange		: "Stavarain lieugur: Eitt ore broytt",
DlgSpellManyChanges		: "Stavarain lieugur: %1 ore broytt",

IeSpellDownload			: "Stavarin ikki lagdur inn. vilt tú heinta hann nú?",

// Button Dialog
DlgButtonText	: "Tekstur (Virei)",
DlgButtonType	: "Slag",

// Checkbox and Radio Button Dialogs
DlgCheckboxName		: "Navn",
DlgCheckboxValue	: "Virei",
...
DlgTextMaxChars		: "H?gst loyvda tal av bókstavum",
DlgTextType			: "Slag",
DlgTextTypeText		: "Tekstur",
DlgTextTypePass		: "Koduore",

// Hidden Field Dialog
DlgHiddenName	: "Navn",
DlgHiddenValue	: "Virei",
...
DlgDocPageTitle		: "Síeu heiti",
DlgDocLangDir		: "Mál",
DlgDocLangDirLTR	: "Frá vinstru móti h?gru (LTR)",
DlgDocLangDirRTL	: "Frá h?gru móti vinstru (RTL)",
...
DlgDocDocTypeOther	: "Annae dokument slag kategori",
...
DlgDocMargins		: "Síeu breddi",
DlgDocMaTop			: "Ovast",
DlgDocMaLeft		: "Vinstra",
DlgDocMaRight		: "H?gra",
DlgDocMaBottom		: "Nieast",
DlgDocMeIndex		: "Dokument index lyklaore (komma sundurskilt)",
DlgDocMeDescr		: "Dokument lysing",
DlgDocMeAuthor		: "H?vundur",
...
DlgTemplatesSelMsg	: "Vel tann frymilin, sum skal opnast í editorinum<br>(Tae vereur skriva útyvir núverandi innihald):",
DlgTemplatesLoading	: "Heintar lista yvir frymlar. Vinarliga bíea...",
DlgTemplatesNoTpl	: "(Ongin frymil er valdur)",

// About Dialog
DlgAboutAboutTab	: "Um",
DlgAboutBrowserInfoTab	: "Browsara upplysingar",
DlgAboutVersion		: "versión",
DlgAboutLicense		: "Loyvi undir treytum fyri GNU Lesser General Public License",
DlgAboutInfo		: "Fleiri upplysingar, far til"
}