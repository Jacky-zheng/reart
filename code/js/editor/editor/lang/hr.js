...
InsertCell			: "Ubaci ?elije",
DeleteCells			: "Izbri?i ?elije",
MergeCells			: "Spoji ?elije",
SplitCell			: "Razdvoji ?elije",
CellProperties		: "Svojstva ?elije",
...
// Alerts and Messages
ProcessingXHTML		: "Obra?ujem XHTML. Molimo pri?ekajte...",
Done				: "Zavr?io",
PasteWordConfirm	: "Tekst koji ?elite zalijepiti ?ini se da je kopiran iz Worda. ?elite li prije o?istiti tekst?",
NotCompatiblePaste	: "Ova naredba je dostupna samo u Internet Exploreru 5.5 ili novijem. ?elite li nastaviti bez ?i??enja?",
...
DlgBtnResetSize		: "Obri?i veli?inu",
DlgImgBorder		: "Okvir",
DlgImgHSpace		: "HSpace",
DlgImgVSpace		: "VSpace",
...
DlgFlashChkMenu		: "Omogu?i Flash izbornik",
DlgFlashScale		: "Omjer",
...
DlgTableCellSpace	: "Prostornost ?elija",
DlgTableCellPad		: "Razmak ?elija",
DlgTableCaption		: "Naslov",

// Table Cell Dialog
DlgCellTitle		: "Svojstva ?elije",
DlgCellWidth		: "?irina",
...
PasteErrorPaste	: "Sigurnosne postavke Va?eg pretra?iva?a ne dozvoljavaju operacije automatskog ljepljenja. Molimo koristite kraticu na tipkovnici (Ctrl+V).",
PasteErrorCut	: "Sigurnosne postavke Va?eg pretra?iva?a ne dozvoljavaju operacije automatskog izrezivanja. Molimo koristite kraticu na tipkovnici (Ctrl+X).",
PasteErrorCopy	: "Sigurnosne postavke Va?eg pretra?iva?a ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tipkovnici (Ctrl+C).",

PasteAsText		: "Zalijepi kao ?isti tekst",
PasteFromWord	: "Zalijepi iz Worda",

DlgPasteMsg2	: "Molimo zaljepite unutar doljnjeg okvira koriste?i tipkovnicu (<STRONG>Ctrl+V</STRONG>) i kliknite <STRONG>OK</STRONG>.",
DlgPasteIgnoreFont		: "Zanemari definiciju vrste fonta",
DlgPasteRemoveStyles	: "Ukloni definicije stilova",
DlgPasteCleanBox		: "O?isti okvir",
...
DlgSpellOneChange		: "Provjera zavr?ena: Jedna rije? promjenjena",
DlgSpellManyChanges		: "Provjera zavr?ena: Promijenjeno %1 rije?i",
...
DlgTemplatesSelMsg	: "Molimo odaberite predlo?ak koji ?elite otvoriti<br>(stvarni sadr?aj ?e biti izgubljen):",
DlgTemplatesLoading	: "U?itavam listu predlo?aka. Molimo pri?ekajte...",
DlgTemplatesNoTpl	: "(Nema definiranih predlo?aka)",

// About Dialog
DlgAboutAboutTab	: "O FCKEditoru",
DlgAboutBrowserInfoTab	: "Podaci o pretra?iva?u",
