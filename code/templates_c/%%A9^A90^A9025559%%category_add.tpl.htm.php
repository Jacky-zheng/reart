<?php /* Smarty version 2.6.6, created on 2009-03-13 05:54:40
         compiled from D:%5Ccvsroot%5Cruiyi%5C./templates//admin/category_add.tpl.htm */ ?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
		...
		<form name="add" method="POST" onsubmit="return checkInput();" action="category.php?act=addSave&tbl=<?php echo $this->_tpl_vars['sTbl']; ?>
">		
		<!--tr>
        ...
        <tr>
          ...
          <td class="altbg2"><input type="text" name="name" size="50" class="input_text"  >&nbsp;&nbsp;*</td>
        </tr>
         <tr>
          <td class="altbg1">英文名称</td>
          <td class="altbg2"><input type="text" name="ename" size="50" class="input_text" /></td>
        </tr>
