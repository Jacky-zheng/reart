 ...
 * 
 * File Authors:
 * 		J?rgen Nordstr?m (jn@FirstWeb.dk)
...
ToolbarCollapse		: "Sammenfold V?rkt?jskasse",
ToolbarExpand		: "Udvid V?rkt?jskasse",
...
Copy				: "Kopier",
Paste				: "Inds?t",
PasteText			: "Inds?t som ren tekst",
PasteWord			: "Inds?t fra Word",
Print				: "Udskriv",
SelectAll			: "V?lg alt",
RemoveFormat		: "Slet formatering",
InsertLinkLbl		: "Link",
InsertLink			: "Inds?t/Rediger Link",
RemoveLink			: "Slet Link",
Anchor				: "Insert/Rediger Anker",
InsertImageLbl		: "Inds?t Billed",
InsertImage			: "Inds?t/Rediger Billed",
InsertFlashLbl		: "Flash",
InsertFlash			: "Inds?t/rediger Flash",
InsertTableLbl		: "Table",
InsertTable			: "Inds?t/Rediger Tabel",
InsertLineLbl		: "Linie",
InsertLine			: "Inds?t horisontal Linie",
InsertSpecialCharLbl: "Special Karakter",
InsertSpecialChar	: "Inds?t Special Karakter",
InsertSmileyLbl		: "Smiley",
InsertSmiley		: "Inds?t Smiley",
About				: "Om FCKeditor",
Bold				: "Fed",
Italic				: "Kursiv",
...
Form			: "Inds?t Form",
Checkbox		: "Inds?t Afkrydsningsboks",
RadioButton		: "Inds?t Radioknap",
TextField		: "Inds?t Tekstfelt",
Textarea		: "Inds?t Tekstboks",
HiddenField		: "Inds?t Skjultfelt",
Button			: "Inds?t Knap",
SelectionField	: "Inds?t Valgfelt",
ImageButton		: "Inds?t Billedknap",

// Context Menu
EditLink			: "Rediger link",
InsertRow			: "Inds?t r?kke",
DeleteRows			: "Slet r?kker",
InsertColumn		: "Inds?t kolonne",
...
Done				: "F?rdig",
PasteWordConfirm	: "Den tekst du fors?ger at inds?tte ser ud til at komme fra Word. Vil du rense teksten f?r den inds?ttes ?",
NotCompatiblePaste	: "Denne kommando er tilg?ndelig i Internet Explorer 5.5 og senere. Vil du inds?tte teksten uden at rense den ?",
UnknownToolbarItem	: "Ukendt v?rkt?jslinje objekt \"%1\"",
UnknownCommand		: "Ukendt kommando navn \"%1\"",
NotImplemented		: "Kommandoen er ikke implementeret",
UnknownToolbarSet	: "V?rkt?jslinjen \"%1\" eksisterer ikke",
...
DlgGenLangDirLtr	: "Venstre mod h?jre (LTR)",
DlgGenLangDirRtl	: "H?jre mod venstre (RTL)",
DlgGenLangCode		: "Sprog kode",
DlgGenAccessKey		: "Adgangsn?gle",
DlgGenName			: "Navn",
...
DlgImgWidth			: "Bredde",
DlgImgHeight		: "H?jde",
DlgImgLockRatio		: "L?s st?rrelsesforhold",
DlgBtnResetSize		: "Nulstil st?rrelse",
DlgImgBorder		: "Ramme",
...
DlgFlashScaleFit	: "Tilpas st?rrelse",
...
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "Anker p? denne side",
DlgLnkTypeEMail		: "Email",
DlgLnkProto			: "Protokol",
DlgLnkProtoOther	: "&lt;anden&gt;",
DlgLnkURL			: "URL",
DlgLnkAnchorSel		: "V?lg et anker",
DlgLnkAnchorByName	: "Efter anker navn",
DlgLnkAnchorById	: "Efter element Id",
DlgLnkNoAnchors		: "&lt;Der er ingen ankre tilg?ngelige i dette dokument&gt;",
...
DlgLnkTargetTop		: "?verste vindue (_top)",
...
DlgLnkPopToolbar	: "V?rkt?jslinje",
DlgLnkPopFullScrn	: "Fuld sk?rm (IE)",
DlgLnkPopDependent	: "Afh?ngig (Netscape)",
DlgLnkPopWidth		: "Bredde",
DlgLnkPopHeight		: "H?jde",
...
DlgCellHorAlignRight: "H?jrestillet",
...
DlgCellRowSpan		: "Antal r?kker cellen sp?nder over",
DlgCellCollSpan		: "Antal kolonner cellen sp?nder over",
DlgCellBackColor	: "Baggrundsfarve",
DlgCellBorderColor	: "rammefarve",
DlgCellBtnSelect	: "V?lg...",
...
PasteErrorPaste	: "Din browsers sikkerhedsindstillinger tillader ikke editoren at inds?tte tekst automatisk. Brug i stedet tastaturet til at inds?tte teksten (Ctrl+V).",
...
PasteAsText		: "Inds?t som ren tekst",
PasteFromWord	: "Inds?t fra Word",

DlgPasteMsg2	: "Inds?t i boksen herunder (<STRONG>Ctrl+V</STRONG>) og klik <STRONG>OK</STRONG>.",
...
DlgSpellNoMispell		: "Stavekontrol f?rdig: Ingen fejl fundet",
DlgSpellNoChanges		: "Stavekontrol f?rdig: Ingen ord ?ndret",
...
// Button Dialog
DlgButtonText	: "Tekst (V?rdi)",
DlgButtonType	: "Type",

// Checkbox and Radio Button Dialogs
DlgCheckboxName		: "Navn",
DlgCheckboxValue	: "V?rdi",
...
DlgDocLangDir		: "Sprog",
DlgDocLangDirLTR	: "Venstre Til H?jre (LTR)",
DlgDocLangDirRTL	: "H?jre Til Venstre (RTL)",
DlgDocLangCode		: "Landekode",
DlgDocCharSet		: "Karakter s?t kode",
DlgDocCharSetOther	: "Anden karakter s?t kode",
...
DlgDocMaRight		: "H?jre",
DlgDocMaBottom		: "Bund",
DlgDocMeIndex		: "Dokument index n?gleord (komma sepereret)",
...
DlgTemplatesSelMsg	: "V?lg den skabelon, som skal ?bnes i editoren<br>(Nuv?rende indhold vil blive overskrevet):",
...
DlgAboutLicense		: "Licens under vilk?r for GNU Lesser General Public License",
