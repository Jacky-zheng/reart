...
ToolbarCollapse		: "Skjul verkt?ylinje",
ToolbarExpand		: "Vis verkt?ylinje",
...
Done				: "Ferdig",
PasteWordConfirm	: "Teksten du pr?ver ? lime inn ser ut som om den kommer fra word , du b?r rense den f?r du limer inn , vil du gj?re dette?",
...
UnknownToolbarSet	: "Verkt?ylinjesett \"%1\" finnes ikke",
...
DlgGenId			: "Id",
DlgGenLangDir		: "Spr?kretning",
DlgGenLangDirLtr	: "Venstre til h?yre (VTH)",
DlgGenLangDirRtl	: "H?yre til venstre (HTV)",
DlgGenLangCode		: "Spr?k kode",
...
DlgGenTitle			: "Tittel",
DlgGenContType		: "Type",
DlgGenLinkCharset	: "Lenket spr?kkart",
DlgGenStyle			: "Stil",
...
DlgImgWidth			: "Bredde",
DlgImgHeight		: "H?yde",
DlgImgLockRatio		: "L?s forhold",
DlgBtnResetSize		: "Tilbakestill st?rrelse",
DlgImgBorder		: "Ramme",
DlgImgHSpace		: "HMarg",
DlgImgVSpace		: "VMarg",
DlgImgAlign			: "Juster",
...
DlgImgAlignRight	: "H?yre",
DlgImgAlignTextTop	: "Tekst topp",
DlgImgAlignTop		: "Topp",
DlgImgPreview		: "Forh?ndsvis",
...
DlgPasteMsg2	: "Vennligst lim inn i den f?lgende boksen med tastaturet (<STRONG>Ctrl+V</STRONG>) og trykk <STRONG>OK</STRONG>.",
DlgPasteIgnoreFont		: "Ignorer fonter",
DlgPasteRemoveStyles	: "Fjern stildefinisjoner",
DlgPasteCleanBox		: "T?m boksen",
...
DlgSpellProgress		: "Stavekontroll p?g?r...",
DlgSpellNoMispell		: "Stavekontroll fullf?rt: ingen feilstavinger funnet",
DlgSpellNoChanges		: "Stavekontroll fullf?rt: ingen ord endret",
DlgSpellOneChange		: "Stavekontroll fullf?rt: Ett ord endret",
DlgSpellManyChanges		: "Stavekontroll fullf?rt: %1 ord endret",
...
DlgDocLangDir		: "Spr?kretning",
DlgDocLangDirLTR	: "Venstre til h?yre (LTR)",
DlgDocLangDirRTL	: "H?yre til venstre (RTL)",
DlgDocLangCode		: "Spr?kkode",
...
DlgAboutInfo		: "Oversatt av Siteman DA<br /><a target=\"_blank\" href=\"http://www.siteman.no\">www.siteman.no</a><br /><br />For mer informasjon g? til"
}