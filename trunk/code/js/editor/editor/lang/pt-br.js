...
Copy				: "Copiar",
Paste				: "Colar",
PasteText			: "Colar como Texto sem Formata??o",
...
ButtonProp			: "Formatar Bot?o",
CheckboxProp		: "Formatar Caixa de Sele??o",
HiddenFieldProp		: "Formatar Campo Oculto",
RadioButtonProp		: "Formatar Bot?o de Op??o",
ImageButtonProp		: "Formatar Bot?o de Imagem",
...
Done				: "Pronto",
PasteWordConfirm	: "O texto que você deseja colar parece ter sido copiado do Word. Você gostaria de remover a formata??o antes de colar?",
NotCompatiblePaste	: "Este comando está disponível para o navegador Internet Explorer 5.5 ou superior. Você gostaria de colar sem remover a formata??o?",
UnknownToolbarItem	: "O item da barra de ferramentas \"%1\" n?o é reconhecido",
UnknownCommand		: "O comando \"%1\" n?o é reconhecido",
NotImplemented		: "O comando n?o foi implementado",
UnknownToolbarSet	: "A barra de ferramentas \"%1\" n?o existe",
...
DlgGenNotSet		: "&lt;n?o ajustado&gt;",
DlgGenId			: "Id",
DlgGenLangDir		: "Dire??o do idioma",
...
DlgGenName			: "Nome",
DlgGenTabIndex		: "índice de Tabula??o",
...
DlgImgInfoTab		: "Informa??es da Figura",
...
DlgImgWidth			: "Largura",
DlgImgHeight		: "Altura",
DlgImgLockRatio		: "Manter propor??es",
...
DlgLnkInfoTab		: "Informa??es do hiperlink",
DlgLnkTargetTab		: "Informa??es de destino",

DlgLnkType			: "Tipo de hiperlink",
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "?ncora nesta página",
DlgLnkTypeEMail		: "E-Mail",
DlgLnkProto			: "Protocolo",
DlgLnkProtoOther	: "&lt;outro&gt;",
DlgLnkURL			: "URL do hiperlink",
DlgLnkAnchorSel		: "Selecione uma ancora",
DlgLnkAnchorByName	: "Pelo Nome da ancora",
DlgLnkAnchorById	: "Pelo Id do Elemento",
DlgLnkNoAnchors		: "&lt;N?o há ancoras disponíveis neste documento&gt;",
DlgLnkEMail			: "Endere?o E-Mail",
...
DlgLnkPopLocation	: "Barra de Endere?os",
...
DlnLnkMsgNoUrl		: "Por favor, digite o endere?o do Hiperlink",
DlnLnkMsgNoEMail	: "Por favor, digite o endere?o de e-mail",
DlnLnkMsgNoAnchor	: "Por favor, selecione uma ancora",

// Color Dialog
DlgColorTitle		: "Selecione uma Cor",
DlgColorBtnClear	: "Limpar",
DlgColorHighlight	: "Visualiza??o",
...
DlgTableAlignNotSet	: "<N?o ajustado>",
...
PasteErrorPaste	: "As configura??es de seguran?a do seu navegador n?o permitem que o editor excute opera??es de colar automaticamente. Por favor, utilize o teclado para colar (Ctrl+V).",
PasteErrorCut	: "As configura??es de seguran?a do seu navegador n?o permitem que o editor excute opera??es de recortar automaticamente. Por favor, utilize o teclado para recortar (Ctrl+X).",
PasteErrorCopy	: "As configura??es de seguran?a do seu navegador n?o permitem que o editor excute opera??es de copiar automaticamente. Por favor, utilize o teclado para copiar (Ctrl+C).",

PasteAsText		: "Colar como Texto sem Formata??o",
PasteFromWord	: "Colar do Word",

DlgPasteMsg2	: "Transfira o link usado no box usando o teclado com (<STRONG>Ctrl+V</STRONG>) e <STRONG>OK</STRONG>.",
DlgPasteIgnoreFont		: "Ignorar defini??es de fonte",
DlgPasteRemoveStyles	: "Remove defini??es de estilo",
...
DlgAnchorErrorName	: "Por favor, digite o nome da ancora",

// Speller Pages Dialog
DlgSpellNotInDic		: "N?o encontrada",
...
DlgSpellNoSuggestions	: "-sem sugest?es de ortografia-",
DlgSpellProgress		: "Verifica??o ortográfica em andamento...",
DlgSpellNoMispell		: "Verifica??o encerrada: N?o foram encontrados erros de ortografia",
DlgSpellNoChanges		: "Verifica??o ortográfica encerrada: N?o houve altera??es",
DlgSpellOneChange		: "Verifica??o ortográfica encerrada: Uma palavra foi alterada",
DlgSpellManyChanges		: "Verifica??o ortográfica encerrada: %1 foram alteradas",

IeSpellDownload			: "A verifica??o ortográfica n?o foi instalada. Você gostaria de realizar o download agora?",
...
DlgSelectChkMulti	: "Permitir múltiplas sele??es",
DlgSelectOpAvail	: "Op??es disponíveis",
...
NumberedListProp	: "Formatar Numera??o",
DlgLstType			: "Tipo",
...
DlgDocLangDir		: "Dire??o do Idioma",
...
DlgDocDocType		: "Cabe?alho Tipo de Documento",
...
DlgDocMeIndex		: "Palavras-chave de Indexa??o do Documento (separadas por vírgula)",
...
DlgTemplatesNoTpl	: "(N?o foram definidos modelos de layout)",

// About Dialog
DlgAboutAboutTab	: "Sobre",
DlgAboutBrowserInfoTab	: "Informa??es do Navegador",
DlgAboutVersion		: "vers?o",
DlgAboutLicense		: "Licenciado sobre os termos da GNU Lesser General Public License",
DlgAboutInfo		: "Para maiores informa??es visite"
}