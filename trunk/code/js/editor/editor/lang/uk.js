...
PasteErrorPaste	: "Настройки безпеки вашого браузера не дозволяють редактору автоматично виконувати операц?? вставки. Будь ласка, використовуйте клав?атуру для цього (Ctrl+V).",
...
DlgLstTypeUCase		: "Л?тери ВЕРХНЬОГО РЕГ?СТРА (A, B, C)",
...
DlgAboutLicense		: "Л?цензовано зг?дно умовам GNU Lesser General Public License",
