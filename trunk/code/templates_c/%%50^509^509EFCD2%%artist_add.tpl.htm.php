<?php /* Smarty version 2.6.6, created on 2009-03-14 15:06:40
         compiled from D:%5Ccvsroot%5Cruiyi%5C./templates//admin/artist_add.tpl.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'D:\cvsroot\ruiyi\./templates//admin/artist_add.tpl.htm', 20, false),)), $this); ?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
		...
		<tr>
			...
			<td class="altbg2"><input type="text" id="name" name="name" size="40" value="">
		   <span class="starHit">*</span></td>
		</tr>
		<tr>
			<td class="altbg1">性别：</td>
			<td class="altbg2"><?php echo smarty_function_html_radios(array('name' => 'sex','options' => ($this->_tpl_vars['aSex']),'checked' => 0), $this);?>
<span class="starHit">*</span></td>
		</tr>
		<tr>
			<td class="altbg1">职业：</td>
			<td class="altbg2"><input type="text" id="profession" name="profession" size="40" value=""></td>
		</tr>
		<tr>
			<td class="altbg1">出生日期：</td>
		  <td class="altbg2">
			  <input type="text" name="birthday" id="birthday" readonly="" value="" class="input_text" />
